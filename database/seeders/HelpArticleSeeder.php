    ...
    public function run(): void
    {
        $articles = [
            ...
            [
                ...
                'body' => '<p>No es una agenda interna. Cada {{organization}} lleva el {{history}} de <strong>sus</strong> {{subject_plural}}. Abra la ficha del {{subject}} y el botón <strong>{{history}}</strong> (timeline). La pestaña de {{case_plural}} asociados lista turnos; el relation manager queda de respaldo.</p><p>Tipos de {{history_entry}} en esta red: <strong>{{history_types}}</strong>.</p><ol><li>El admin de red activa el módulo en Preferencias operativas, la sede y los tipos. Esa cuenta <strong>no lee</strong> el contenido.</li><li>Con la cuenta de sede, el admin crea el {{subject}}. El operador abre la ficha (no edita nombre ni {{client}}) y carga un {{history_entry}} con acciones rápidas: tipo, fecha, resumen (si queda vacío se propone al finalizar), campos del tipo, adjuntos privados (miniatura de fotos).</li><li>El borrador puede estar incompleto. <strong>Finalice</strong> cuando los campos obligatorios estén. Lo final no se edita: use <strong>Adenda</strong>.</li><li><strong>Descargar PDF</strong> de un {{history_entry}} final o <strong>Descargar ficha PDF</strong> (carátula con último peso y próximos, luego los finales). No incluye borradores ni archivos. Queda auditado.</li><li>El dashboard muestra <strong>Próximos de mi clínica</strong> (solo finales de esa sede).</li><li><strong>Compartir con {{case}}</strong> solo si quiere que esa atención vea <em>ese</em> {{history_entry}} (tipo, fecha y resumen), no el cuaderno ni los adjuntos.</li><li>Otras {{organization_plural}} no ven estos datos. El especialista, si no se compartió, tampoco.</li></ol>',
            ],
            [
                'slug' => 'orden-de-venta',
                'title' => 'Orden de venta para el ERP',
                'category' => HelpArticle::CATEGORY_OPERATION,
                'audience_roles' => ['organization_admin', 'operator'],
                'sort_order' => 56,
                'excerpt' => 'Desde un registro final de su sede se emite una orden interna (PDF y CSV). SURC no factura.',
                'body' => '<p>La orden nace solo de un {{history_entry}} <strong>final</strong> de <strong>su</strong> {{organization}}. Aunque el {{case}} se atienda en una agenda abierta de otra sede, la orden queda en la clínica dueña del {{history}}.</p><ol><li>El admin de clínica carga el <strong>catálogo de venta</strong> (código ERP, precio, impuesto informativo, moneda). El operador usa ítems activos; no cambia precios.</li><li>En la ficha de la {{organization}} complete moneda (p. ej. UYU), prefijo y datos del emisor. No usa la moneda de las señas.</li><li>En el {{history_entry}} final pulse <strong>Orden de venta</strong>. Se sugieren ítems ligados a ese tipo. Puede agregar líneas a mano. No copia diagnóstico, tratamiento ni adjuntos. La seña del {{case}}, si existe, es solo informativa.</li><li><strong>Emitir</strong> asigna el número (OV-000001) y deja la orden inmutable.</li><li>Descargue <strong>PDF</strong> o <strong>CSV</strong> genérico para el ERP. Cada descarga queda auditada. Anote luego la referencia que genere el facturador.</li></ol><p>El especialista, la anfitriona, el admin de red y el dueño de plataforma no abren estas órdenes. SURC no emite comprobantes fiscales ni se conecta por API al ERP.</p>',
            ],
            [
            ...
            [
                ...
                'audience_roles' => ['network_admin', 'organization_admin', 'operator', 'specialist'],
                'sort_order' => 65,
                'excerpt' => 'Admin de sede da de alta. Operador opera el mostrador, el cuaderno y las órdenes. El especialista atiende lo suyo. El admin de red no lee el {{history}}.',
                'body' => '<ul><li><strong>Admin de sede:</strong> usuarios de su {{organization}}, actores, {{subject_plural}}, agendas, {{case_plural}}, catálogo de venta y {{history}}.</li><li><strong>Operador:</strong> listados, espacio de trabajo, señas, {{history}} y órdenes de venta de su sede. Abre la ficha del {{subject}} en solo lectura. No cambia precios del catálogo.</li><li><strong>Especialista:</strong> sus agendas y {{case_plural}}. No confirma pagos ni ve el cuaderno salvo lo compartido. No ve órdenes de venta.</li><li><strong>Admin de red:</strong> configura tipos, flags y el sitio público. No lee, edita, comparte ni imprime el {{history}} ni las órdenes clínicas.</li></ul>',
            ],
            [
                'slug' => 'sitio-publico',
